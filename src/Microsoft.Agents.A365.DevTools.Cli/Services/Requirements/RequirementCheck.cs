...
public abstract class RequirementCheck : IRequirementCheck
{
    ...
    {
        logger.LogDebug("Pass: {Name}{Details}", Name,
    ...
    {
        logger.LogDebug("Warn: {Name}{Details}", Name,
